  ...
  return (
    <div>
      ...
      <div
        ...
        tabIndex={1}
        aria-hidden='true'
        className='h-modal fixed top-0 left-0 right-0 z-50 hidden w-full items-center justify-center overflow-y-auto overflow-x-hidden bg-black bg-opacity-50 p-4  dark:bg-gray-900 dark:bg-opacity-50 md:inset-0 md:h-full'
      >
